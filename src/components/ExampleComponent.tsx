...
export const ExampleComponent: React.FC = () => {
  ...
  return (
    <div className="max-w-md mx-auto p-6 bg-white rounded-lg shadow-md">
      <h2 className="text-xl font-semibold mb-4 text-gray-800">File Upload Example</h2>
      <button 
      ...
      {selectedFiles.length > 0 && (
        <div className="mt-4">
          <h3 className="text-md font-medium mb-2 text-gray-700">Selected Files ({selectedFiles.length})</h3>
